...
// to convert HomePage from static to dynamic always
export const dynamic = "force-dynamic";
// to make HomePage static from beginning and each 10s make revalidate(refresh) for data to be updated (make it dynamic after 10s)
